...
class XfRowSpec extends FlatSpec {
...
"""
  ...
  "A vector of XfRow objects"  should "be automatically generated from a corpus of citable texts" in {
    val xfcols = corpus.to82xfVector
    xfcols match {
      case xf: Vector[XfRow] => assert(true)
