...
*/
@JSExportAll case class TextRepositoryVector (corpus: CorpusVector, catalog: CatalogVector) extends TextRepository[TextRepositoryVector] with LogSupport {
